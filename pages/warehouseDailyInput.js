  ...
  warehouseItems.forEach((item) => {
    ...
    movementFields.forEach((movement) => {
      ...
      warehouseLogEntries.push({
        ...
        unit: item.unit || "",
        managerReviewedBy,
        source: movement.movementType === "Transfer In" ? "Warehouse Daily Input" : "Warehouse",
        destination:
  ...
  return `
    <div class="instruction-box">
      ...
      <span>
        ...
        Master List. This page is only for today’s warehouse transaction input.
      </span>
    </div>
...
function getWarehouseDailyInputContent() {
  ...
  return `
    <section class="panel">
      ...
      <div class="instruction-box">
        <strong>Daily Input Rule:</strong>
        <span>
          Transfer In adds to Warehouse Stock. Transfer Out and Waste deduct from Warehouse Stock.
          The final stock update will come from posted Warehouse Log Transaction entries.
        </span>
      </div>
